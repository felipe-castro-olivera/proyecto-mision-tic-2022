<template>
  <v-form v-model="valid">
    <v-container>
      <v-row>
        <v-col cols="12" md="6">
          <h2 class="mb-5">Agregar paciente</h2>
          <v-text-field
            v-model="nombre"
            :rules="fieldsRules"
            label="Nombre"
    ...
    async agregarPaciente() {
      ...
      try {
        const respuesta = await axios.post(
          "https://us-east4.gcp.data.mongodb-api.com/app/api-endpoints-ewdzk/endpoint/paciente",
          datosPaciente
        );
